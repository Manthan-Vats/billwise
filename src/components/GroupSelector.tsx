...
import { Users, Plus, Trash2, ChevronDown, UserPlus, Copy, BarChart3 } from 'lucide-react';
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex space-x-2">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={onJoinGroup}
            className="bg-emerald-600 hover:bg-emerald-700 text-white p-2 rounded-lg transition-all duration-200"
            title="Join Group"
          >
      ...
      {groups.length === 0 ? (
        <div className="text-center py-8">
          ...
          >
            ...
            <h3 className="font-medium text-slate-700 mb-2">No groups yet</h3>
            <p className="text-sm text-slate-600 mb-4">Create your first group or join an existing one</p>
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <div className="flex items-center space-x-1 bg-slate-100 px-2 py-1 rounded text-xs font-mono">
                      <span className="text-slate-600">{group.groupCode}</span>
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                  ...
                  <p className="text-sm text-slate-600">
                    ...
                    {group.budget && ` • Budget: ${group.currency} ${group.budget}`}
                  </p>
                </div>
