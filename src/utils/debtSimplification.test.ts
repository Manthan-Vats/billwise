...
describe("debtSimplification", () => {
  ...
  describe("calculateBalances", () => {
    ...
    it("should handle settlements correctly", () => {
      ...
      const balancesWithSettlements = calculateBalances(
        group,
        expenses,
        settlements,
      );
      ...
      expect(balancesWithSettlements[member1.id]).toBeCloseTo(
        balancesWithoutSettlements[member1.id],
        2,
      );
      expect(balancesWithSettlements[member2.id]).toBeCloseTo(
        balancesWithoutSettlements[member2.id],
        2,
      );
      expect(balancesWithSettlements[member3.id]).toBeCloseTo(
        balancesWithoutSettlements[member3.id],
        2,
      );
    });
